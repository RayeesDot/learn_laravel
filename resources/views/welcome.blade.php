...
<body
    ...
    @php
        ...
        $obj = new makeingobj("Rayees Ahmad Gadda", "Kashmir");

        echo "<p> Name: {$obj->name} <br> Address: {$obj->address} </p>";
        ...
        class staticclass
        {
            ...
            public static function printfun($name, $address)
            {
                // calling static properties inside own class using self keyword
                echo self::$name = $name;
                echo self::$address = $address;
            }
        }
        // no need to create object for static class, we can call static method directly using class name
        staticclass::printfun("Rayees Ahmad Gadda", "Kashmir");

        echo "<br>" . str_replace("rayeees", "Rayees", "Hello rayeees!") . "<br>";
        echo strrev("looc");

        echo "<br>";
        $arr = explode(" ", "Hello World! This is Rayees Ahmad Gadda");
        for ($i = 0; $i < count($arr); $i++) {
            echo $arr[$i] . " ";
        }
        echo "<br>";
        foreach (["Rayees", "Ahmad", "Gadda"] as $value) {
            echo $value . " ";
        }
        echo substr("hello world", -9);
        ...
        echo "<br>";
        var_dump($b);
        //__DIR__ is a magic constant in PHP that returns the directory of the current file. It is useful for including files or for debugging purposes. In this case, it will output the directory path of the welcome.blade.php file.
        echo "<br>";
        echo __DIR__;
        echo "<br>";
        echo __FILE__;
        ...
        echo "<br>";
        // sum of unknow number of parameters
        // note: the ...$x syntax is used to indicate that the function can accept a variable number of arguments. The function will treat all the arguments passed to it as an array, which can be accessed using the $x variable.
        function sum(...$x)
        {
            $sum = 0;
            for ($i = 0; $i < count($x); $i++) {
    ...
    @php
        ...
        echo sum2(10, 20);
        // we can also specify the return type of the function by adding a colon (:) followed by the desired type after the closing parenthesis of the function declaration. In this case, we are specifying that the sum3 function will return a float value.
        function sum3(int $a, float $b): float
        {
            return $a + $b;
        }
        echo sum3(10, 20.5);
